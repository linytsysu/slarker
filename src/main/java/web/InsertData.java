...
//		if (region_repo.count() > 0) return;	// count > 0 means mysql database has been inserted data.
		...
		// new Movie
		List<String> directors_1 = new ArrayList<String>();
		directors_1.add("詹姆斯·波宾");
		List<String> actors_1 = new ArrayList<String>();
		actors_1.add("约翰尼·德普-饰-疯帽先生");
		actors_1.add("安妮·海瑟薇-饰-白女王");
		actors_1.add("米娅·华希科沃斯卡-饰-爱丽丝");
		actors_1.add("海伦娜·伯翰·卡特-饰-红桃女王");
		actors_1.add("迈克尔·辛-饰-白兔子");
		List<String> types_1 = new ArrayList<String>();
		types_1.add("奇幻");
		types_1.add("冒险");
		Calendar release_time_1 = Calendar.getInstance();
		release_time_1.set(2016, 5, 27);
		List<String> version_1 = new ArrayList<String>();
		version_1.add("IMAX3D");
		version_1.add("2D");
		version_1.add("3D");
		version_1.add("巨幕");
		Movie movie_1 = new Movie("爱丽丝梦游仙境2：镜中奇遇记", directors_1, actors_1, "ailisimengyouxianjing2.jpg", types_1, "美国", "英语", "1小时55分钟", release_time_1, version_1, 8.4, "ailisimengyouxianjing2_bg.jpg");
