...
public class InsertData implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent arg0) {
		...
		actors.add("宝拉·巴顿-饰-迦罗娜");
		actors.add("崔维斯·费米尔-饰-安杜因·洛萨");
		actors.add("托比·凯贝尔-饰-杜隆坦");
		actors.add("罗伯特·卡辛斯基-饰-奥格瑞姆");
		actors.add("本·福斯特-饰-麦迪文");
		actors.add("多米尼克·库珀-饰-莱恩·乌瑞恩国");
		actors.add("克兰西·布朗-饰-黑手");
		actors.add("本·施耐泽-饰-卡德加");
		actors.add("吴彦祖-饰-古尔丹");
		...
		directors.add("费格尔·雷利");
		directors.add("克雷·卡提斯");
		...
		directors.add("布莱恩·辛格");
		List<String> actors_4 = new ArrayList<String>();
		actors.add("迈克尔·法斯宾德-饰-万磁王");
		actors.add("詹姆斯·麦卡沃伊詹姆斯·麦卡沃伊-饰-X教授");
		actors.add("詹妮弗·劳伦斯-饰-变形女");
		actors.add("尼古拉斯·霍尔特-饰-野兽");
		actors.add("伊万·彼得斯-饰-快银");
		actors.add("奥斯卡·伊萨克-饰-成年天启");
		actors.add("索菲·特纳-饰-凤凰女");
		actors.add("泰尔·谢里丹-饰-镭射眼");
		actors.add("亚历山德拉·西普-饰 -暴风女");
